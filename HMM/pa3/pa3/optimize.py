...
#Computes the gamma variable which is a 2D array
...
# Calculates and returns the new epsilon variable
# Epsilon is a 3D array
...
if __name__ == '__main__':
    ...
    for observation in observations:#since number of iterations = 1
        ...
        #Printing the old probability along with the old one
